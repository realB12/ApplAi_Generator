...
|   |   |   |       ├── api/           # Supabase Storage (Applai/SuperCV) API calls, User Settings API calls
|   |   |   |       ├── components/    # S002, TVC01, S002D1, S002D2, S002S1 components
|   |   |   |       ├── hooks/         # useSuperCVFiles/useLoadSuperCV/useExportSuperCV, useTreeView, useSettings
|   |   |   |       ├── stores/        # Resume Zustand slice
|   |   |   |       ├── types/         # SuperCVDocument / Section Registry types (§5, §5a), UserSettings types  
...
|   └─ server                          # for a potential Backend/Server  - currently not used but left as a reminder
